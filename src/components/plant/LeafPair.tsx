...
const LeafPair: React.FC<LeafPairProps> = ({ 
  ...
  return (
    <>
      ...
      <div 
        className="absolute animate-in fade-in duration-700 hover:rotate-3 transition-transform" 
        style={{ 
      ...
      <div 
        className="absolute animate-in fade-in duration-700 hover:rotate-[-3deg] transition-transform" 
        style={{ 
          bottom: `${bottomPosition}px`, 
          left: 'calc(50%)', 
